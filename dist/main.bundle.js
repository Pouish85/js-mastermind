...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n  margin: 0;\n  padding: 0;\n}\n\nbody {\n  display: flex;\n  justify-content: center;\n}\n\n.row {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 10px;\n  padding-top: 8px;\n  border-top: 1px solid white;\n}\n\n.colors {\n  width: 50px;\n  height: 50px;\n  border-radius: 50%;\n  margin-right: 15px;\n}\n\n#yellow {\n  background-color: yellow;\n}\n\n#blue {\n  background-color: blue;\n}\n\n#red {\n  background-color: red;\n}\n\n#green {\n  background-color: green;\n}\n\n#orange {\n  background-color: orangered;\n}\n\n#purple {\n  background-color: purple;\n}\n\n#white {\n  background-color: white;\n}\n\n#black {\n  background-color: black;\n  color: white;\n}\n\n.gameContainer {\n  width: 500px;\n  height: 1270px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-direction: column;\n  border: 1px solid black;\n  background-color: #a45729;\n  border-radius: 10px;\n  border-bottom: 3px solid black;\n}\n.gameContainer h1 {\n  font-size: 70px;\n  margin-bottom: 25px;\n}\n.gameContainer #hiddenCombination {\n  margin-bottom: 15px;\n}\n.gameContainer #hiddenCombination .colors {\n  width: 70px;\n  height: 70px;\n  transform: translateX(15px);\n}\n.gameContainer .status {\n  font-size: 20px;\n  margin-bottom: 15px;\n}\n.gameContainer #attemptsContainer {\n  display: flex;\n  flex-direction: column;\n  transform: translateX(25px);\n}\n.gameContainer #attemptsContainer .number {\n  width: 40px;\n  height: 40px;\n  border-radius: 50%;\n  margin-right: 15px;\n  transform: translateX(-30px);\n}\n.gameContainer #attemptsContainer .square {\n  height: 50px;\n  width: 50px;\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: space-around;\n  margin-top: 10px;\n}\n.gameContainer #attemptsContainer .square .resultsColors {\n  height: 18px;\n  width: 18px;\n  border-radius: 50%;\n  background-color: transparent;\n}\n.gameContainer #currentAttempt {\n  transform: translateX(-28px);\n  text-align: center;\n}\n.gameContainer #currentAttempt .currentText {\n  width: 100px;\n  height: 40px;\n  border-radius: 10px;\n  margin-right: 15px;\n}\n.gameContainer #colorBtn {\n  margin-top: 25px;\n  transform: translateX(10px);\n}\n.gameContainer #colorBtn .colors {\n  width: 60px;\n  height: 60px;\n}\n.gameContainer .btn {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n}\n.gameContainer .btn #cancelBtn, .gameContainer .btn #submitBtn {\n  width: 100px;\n  height: 25px;\n  margin-top: 25px;\n  border: none;\n  border-radius: 10px;\n  border-bottom: 1 px solid black;\n  border-top: 1px solid white;\n}\n.gameContainer .btn #cancelBtn {\n  margin-right: 10px;\n}\n.gameContainer .btn #submitBtn {\n  margin-left: 10px;\n}", "",{"version":3,"sources":["webpack://./src/assets/styles/_reset.scss","webpack://./src/assets/styles/index.scss","webpack://./src/assets/styles/_base.scss","webpack://./src/assets/styles/_classes.scss","webpack://./src/assets/styles/_variables.scss","webpack://./src/assets/styles/_mixins.scss"],"names":[],"mappings":"AAAA;EACI,SAAA;EACA,UAAA;ACCJ;;ACDA;EACI,aAAA;EACA,uBAAA;ADIJ;;ACAA;EACI,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,mBAAA;EACA,gBAAA;EACA,2BAAA;ADGJ;;ACAA;EACI,WAAA;EACA,YAAA;EACA,kBAAA;EACA,kBAAA;ADGJ;;ACAA;EACI,wBAAA;ADGJ;;ACAA;EACI,sBAAA;ADGJ;;ACAA;EACI,qBAAA;ADGJ;;ACAA;EACI,uBAAA;ADGJ;;ACAA;EACI,2BAAA;ADGJ;;ACAA;EACI,wBAAA;ADGJ;;ACAA;EACI,uBAAA;ADGJ;;ACAA;EACI,uBAAA;EACA,YAAA;ADGJ;;AEzDA;EACI,YAAA;EACA,cAAA;EACA,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,sBAAA;EACA,uBAAA;EACA,yBCPW;EDQX,mBAAA;EACA,8BAAA;AF4DJ;AE1DI;EACI,eAAA;EACA,mBAAA;AF4DR;AEzDI;EACI,mBAAA;AF2DR;AEzDQ;EACI,WAAA;EACA,YAAA;EACA,2BAAA;AF2DZ;AEvDI;EACI,eAAA;EACA,mBAAA;AFyDR;AEtDI;EACI,aAAA;EACA,sBAAA;EACA,2BAAA;AFwDR;AEtDQ;EACI,WAAA;EACA,YAAA;EACA,kBAAA;EACA,kBAAA;EACA,4BAAA;AFwDZ;AErDQ;EACI,YAAA;EACA,WAAA;EACA,aAAA;EACA,eAAA;EACA,6BAAA;EACA,gBAAA;AFuDZ;AErDY;EACI,YAAA;EACA,WAAA;EACA,kBAAA;EACA,6BAAA;AFuDhB;AEjDI;EACI,4BAAA;EACA,kBAAA;AFmDR;AEjDQ;EACI,YAAA;EACA,YAAA;EACA,mBAAA;EACA,kBAAA;AFmDZ;AE9CI;EACI,gBAAA;EACA,2BAAA;AFgDR;AE9CQ;EACI,WAAA;EACA,YAAA;AFgDZ;AE5CI;EErFA,aAAA;EACA,mBAFoB;EAGpB,uBAHmC;EAInC,mBAJmD;AJwIvD;AE/CQ;EACI,YAAA;EACA,YAAA;EACA,gBAAA;EACA,YAAA;EACA,mBAAA;EACA,+BAAA;EACA,2BAAA;AFiDZ;AE9CQ;EACI,kBAAA;AFgDZ;AE7CQ;EACI,iBAAA;AF+CZ","sourcesContent":["* {\n    margin: 0;\n    padding: 0;\n}","* {\n  margin: 0;\n  padding: 0;\n}\n\nbody {\n  display: flex;\n  justify-content: center;\n}\n\n.row {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 10px;\n  padding-top: 8px;\n  border-top: 1px solid white;\n}\n\n.colors {\n  width: 50px;\n  height: 50px;\n  border-radius: 50%;\n  margin-right: 15px;\n}\n\n#yellow {\n  background-color: yellow;\n}\n\n#blue {\n  background-color: blue;\n}\n\n#red {\n  background-color: red;\n}\n\n#green {\n  background-color: green;\n}\n\n#orange {\n  background-color: orangered;\n}\n\n#purple {\n  background-color: purple;\n}\n\n#white {\n  background-color: white;\n}\n\n#black {\n  background-color: black;\n  color: white;\n}\n\n.gameContainer {\n  width: 500px;\n  height: 1270px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-direction: column;\n  border: 1px solid black;\n  background-color: #a45729;\n  border-radius: 10px;\n  border-bottom: 3px solid black;\n}\n.gameContainer h1 {\n  font-size: 70px;\n  margin-bottom: 25px;\n}\n.gameContainer #hiddenCombination {\n  margin-bottom: 15px;\n}\n.gameContainer #hiddenCombination .colors {\n  width: 70px;\n  height: 70px;\n  transform: translateX(15px);\n}\n.gameContainer .status {\n  font-size: 20px;\n  margin-bottom: 15px;\n}\n.gameContainer #attemptsContainer {\n  display: flex;\n  flex-direction: column;\n  transform: translateX(25px);\n}\n.gameContainer #attemptsContainer .number {\n  width: 40px;\n  height: 40px;\n  border-radius: 50%;\n  margin-right: 15px;\n  transform: translateX(-30px);\n}\n.gameContainer #attemptsContainer .square {\n  height: 50px;\n  width: 50px;\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: space-around;\n  margin-top: 10px;\n}\n.gameContainer #attemptsContainer .square .resultsColors {\n  height: 18px;\n  width: 18px;\n  border-radius: 50%;\n  background-color: transparent;\n}\n.gameContainer #currentAttempt {\n  transform: translateX(-28px);\n  text-align: center;\n}\n.gameContainer #currentAttempt .currentText {\n  width: 100px;\n  height: 40px;\n  border-radius: 10px;\n  margin-right: 15px;\n}\n.gameContainer #colorBtn {\n  margin-top: 25px;\n  transform: translateX(10px);\n}\n.gameContainer #colorBtn .colors {\n  width: 60px;\n  height: 60px;\n}\n.gameContainer .btn {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n}\n.gameContainer .btn #cancelBtn, .gameContainer .btn #submitBtn {\n  width: 100px;\n  height: 25px;\n  margin-top: 25px;\n  border: none;\n  border-radius: 10px;\n  border-bottom: 1 px solid black;\n  border-top: 1px solid white;\n}\n.gameContainer .btn #cancelBtn {\n  margin-right: 10px;\n}\n.gameContainer .btn #submitBtn {\n  margin-left: 10px;\n}","@import './mixins';\n\nbody {\n    display: flex;\n    justify-content: center;\n    \n}\n\n.row {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    margin-bottom: 10px;\n    padding-top: 8px;\n    border-top: 1px solid white;\n}\n\n.colors {\n    width: 50px;\n    height: 50px;\n    border-radius: 50%;\n    margin-right: 15px;\n}\n\n#yellow {\n    background-color: yellow;\n}\n\n#blue {\n    background-color: blue;\n}\n\n#red {\n    background-color: red;\n}\n\n#green {\n    background-color: green;\n}\n\n#orange {\n    background-color: orangered;\n}\n\n#purple {\n    background-color: purple;\n}\n\n#white {\n    background-color: white;\n}\n\n#black {\n    background-color: black;\n    color: white;\n}\n\n",".gameContainer {\n    width: 500px;\n    height: 1270px;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    flex-direction: column;\n    border: 1px solid black;\n    background-color: $board-color;\n    border-radius: 10px;\n    border-bottom: 3px solid black;\n\n    h1{\n        font-size: 70px;\n        margin-bottom: 25px;\n    }\n\n    #hiddenCombination {\n        margin-bottom: 15px;\n\n        .colors {\n            width: 70px;\n            height: 70px;\n            transform: translateX(15px);\n        }\n    }\n\n    .status {\n        font-size: 20px;\n        margin-bottom: 15px;\n    }\n\n    #attemptsContainer {\n        display: flex;\n        flex-direction: column;\n        transform: translateX(25px);\n\n        .number {\n            width: 40px;\n            height: 40px;\n            border-radius: 50%;\n            margin-right: 15px;\n            transform: translateX(-30px);\n        }\n\n        .square {\n            height: 50px;\n            width: 50px;\n            display: flex;\n            flex-wrap: wrap;\n            justify-content: space-around;\n            margin-top: 10px;\n\n            .resultsColors {\n                height: 18px;\n                width: 18px;\n                border-radius: 50%;\n                background-color: transparent;\n            }\n            \n        }\n    }\n    \n    #currentAttempt {\n        transform: translateX(-28px);\n        text-align: center;\n    \n        .currentText {\n            width: 100px;\n            height: 40px;\n            border-radius: 10px;\n            margin-right: 15px;\n        \n        }\n    }\n\n    #colorBtn {\n        margin-top: 25px;\n        transform: translateX(10px);\n\n        .colors{\n            width: 60px;\n            height: 60px;\n        }\n    }\n\n    .btn {\n        @include flex;\n\n        #cancelBtn, #submitBtn {\n            width: 100px;\n            height: 25px;\n            margin-top: 25px;\n            border: none;\n            border-radius: 10px;\n            border-bottom: 1 px solid black;\n            border-top: 1px solid white;\n        }\n\n        #cancelBtn {\n            margin-right: 10px;\n        }\n\n        #submitBtn {\n            margin-left: 10px;\n        }\n    }\n\n}","\n$board-color:  #a45729;","@mixin flex($direction: row, $justify: center, $align: center) {\n    display: flex;\n    flex-direction: $direction;\n    justify-content: $justify;\n    align-items: $align;\n}"],"sourceRoot":""}]);
// Exports
...
(0,_display_js__WEBPACK_IMPORTED_MODULE_1__.hiddenCombination)(colorsList, hiddenComnationLength);
(0,_display_js__WEBPACK_IMPORTED_MODULE_1__.currentAttemptDisp)(currentAttempt, hiddenComnationLength);
})();
